...
export default function HomePage() {
      ...
      if (tag) {
        ...
        try {
          const res = await axios.get(
            `http://localhost:8000/video/getVideosByTag/${tag.tag_id}`
          );
  ...
  const sortByUploadDate = () => {
    const newVideoList = videos.sort(
      ({ upload_date: upload_date1 }, { upload_date }) => {
          ...
          <div className="content-container">
              ...
              <div className="search-group">
                ...
                <div className="topic-group">
                  ...
                  <div className="dropdown">
                    <button
                      className="topic-item"
                      onClick={() => showDropdownCategories()}
                    >
                      Categories
                    </button>
                    {showDropdown && (
            ...
            <div className="advertisement">
              <div className="paragraph">
                <p className="p1">
                  {" "}
                  By Group 9 in <span className="highlight"> ICT-K65</span>
                </p>
                <h1>
            ...
            <div className="middle-content">
              ...
              <div className="group-blog">
                {currentVideos.map(
                  ({ video_id, description, link_img, video_title, view }) => (
                    <Link key={video_id} to={`/video/${video_id}`}>
              ...
              <div className="nav">
                <button className="nav-btn btn-fail" onClick={handlePrevPage}>
                  {" "}
                  &lt;{" "}
                </button>
